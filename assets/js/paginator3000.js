...
*/
var Paginator = function(paginatorHolderId, pagesTotal, pagesSpan, pageCurrent, baseUrl, afterDrawHandler){
	...
	baseUrl: baseUrl ? baseUrl : '/pages/',
        afterDrawHandler: afterDrawHandler
    };
...
Paginator.prototype.makePagesTableHtml = function(){
    ...
    html += '</tr><tr><td colspan="' + this.inputData.pagesSpan + '">' +
...
Paginator.prototype.drawPages = function(){
    ...
    if (this.inputData.afterDrawHandler) {
        this.inputData.afterDrawHandler();
    }
}
